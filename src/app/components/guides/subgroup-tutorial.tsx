...
const SubgroupTutorial = () => {
  return (
    <>
      <p className='qpp-docs-page-updated'>Last Updated: 10/01/2023</p> {/* IMPORTANT: update this Last-Updated value if you have made any changes to this page's content. */}
