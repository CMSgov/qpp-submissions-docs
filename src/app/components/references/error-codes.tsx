...
const ErrorCodes: React.FC<DocPageProps> = ({dataTestId}: DocPageProps) => {
  return (
    <div data-testid={dataTestId}>
      ...
      <h3 className='ds-text-heading--lg'>To review a list of response codes provided by the API, please visit the <ExternalLink href={`${envConfig.qppCmsPreviewUrl}/api/submissions/public/docs`} text='Submission swagger docs' />.</h3>
    </div>
  );
};
