...
const Benchmarks = () => {
  return (
    <>
      ...
      <p>
        Please see the <ExternalLink href={`${envConfig.amazoneawsUrl}/uploads/608/2022%20Quality%20Benchmarks.zip`}
        text='2022 Merit-based Incentive Payment System (MIPS) Quality Measure Benchmarks Overview' /> for more information on MIPS Quality Benchmarks.
      </p>
      <p>
