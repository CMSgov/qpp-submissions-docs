...
const TermsOfService: React.FC<DocPageProps> = ({dataTestId}: DocPageProps) => {
  return (
    <div data-testid={dataTestId}>
      ...
      <h2 className='ds-text-heading--2xl' style={{marginTop: 0}}>API Terms of Service Agreement</h2>
      ...
      <h3 className='ds-text-heading--xl'>Scope</h3>
      <p className='ds-text-body--md'>
      ...
      <h3 className='ds-text-heading--xl'>Data Rights and Usage</h3>

      <h4 className='ds-text-heading--lg'>Accounts/Registration</h4>
      <p className='ds-text-body--md'>
      ...
      <h4 className='ds-text-heading--lg'>Attribution</h4>
      <p className='ds-text-body--md'>
      ...
      <h3 className='ds-text-heading--xl'>Service Management</h3>

      <h4 className='ds-text-heading--lg'>Right to Limit</h4>
      <p className='ds-text-body--md'>
      ...
      <h4 className='ds-text-heading--lg'>Service Termination</h4>
      <p className='ds-text-body--md'>
      ...
      <h3 className='ds-text-heading--xl'>Liability</h3>

      <h4 className='ds-text-heading--lg'>Disclaimer of Warranties</h4>
      <p className='ds-text-body--md'>
      ...
      <h3 className='ds-text-heading--xl'>No Waiver Rights</h3>
      <p className='ds-text-body--md'>
