    ...
    if (path === 'tutorial') {
      ...
      component = <section className="usa-section">
        <div className="usa-grid">
          ...
          <p className="usa-font-lead">To view or download sample submission data, <a href="/qpp-submissions-docs/examples">click here</a>. This will let you validate your own submission formatting in XML or JSON.</p>
