...
`}/>
          ...
          <button className="usa-button api-example-button">
          ...
          <button className="usa-button api-example-button">Get Submission Score</button>
        ...
        <div className="usa-width-one-half">
          <TechnicalDetailsPane hash={this.props.hash} tutorial="basic"/>
        </div>
      </div>
    );
  }
