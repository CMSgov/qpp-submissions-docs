...
`}/>
          ...
          <button className="usa-button api-example-button" onClick={this.createMeasurementSet}>
          ...
          <button className="usa-button api-example-button" onClick={this.scoreSubmission}>Get Submission Score</button>
