  ...
  render() {
    return (
      <div>
        ...
        <p className='ds-text'>Developer Preview accounts are separate from the ones used to log in to the main QPP website. To create a Developer Preview account, please follow the process at <ahref='https://impl.harp.qualitynet.org/register/profile-info'>https://impl.harp.qualitynet.org/register/profile-info/</a>.</p>
        <p className='ds-text'>Once you’ve created this account (identify verification is required), you will be able to log in to our Developer Preview environment at <ahref='https://preview.qpp.cms.gov'>https://preview.qpp.cms.gov/</a>.</p>
        <p className='ds-text'>Once logged in, you will have the ability to connect to your EHR. The EHR will have the name registered in the <ahref='https://chpl.healthit.gov/'>CHPL</a> database. If your EHR does not show up, you can create one using manual text input.</p>
        ...
        <p className='ds-text'>Once set up, additional support, along with a sample OAuth Client, can be found in the QPP Github at <ahref='https://github.com/CMSgov/qpp-submissions-docs/tree/master/oauth_sample'>https://github.com/CMSgov/qpp-submissions-docs/tree/master/oauth_sample/</a>.</p>
