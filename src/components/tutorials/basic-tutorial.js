      ...
      <div>
        <div>
          <div className='temp-grid'>
            ...
            <p>When submitting, you can pass an <code>Accept</code> header to specify the API version and type of response back. We use a custom mime type, <code>application/vnd.qpp.cms.gov.v1+json</code>, and support JSON and XML. Right now, only <code>v1</code> is supported. You can also contiue to use a standard <code>application/json</code> or <code>application/xml</code> header.</p>
