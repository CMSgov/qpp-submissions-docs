      ...
      <div>
        <div>
          <div className='temp-grid'>
            ...
            <p>Since the API and scoring logic are updated on a regular basis as per the annual publication of the QPP Final Rule, please note that some numbers (especially scoring) may be inaccurate. The <a href='https://qpp-submissions-sandbox.navapbc.com/'>Interactive Docs</a> and Developer Preview will always reflect the latest design.</p>
            ...
            <h3>Next steps</h3>
            <p>Updating and correcting performance data is also easy - avoid losing time by solving issues as they arise, rather than reacting months later. Go to the advanced tutorial to see how you can update a measurement set that you've previously submitted.</p>
            <a className='ds-c-button ds-c-button--primary' href='/qpp-submissions-docs/advanced-tutorial'>Updating and scoring a submission</a>
