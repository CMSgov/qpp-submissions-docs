    ...
    if (path === 'tutorial') {
      ...
      component = <section>
        <div className="ds-u-measure--wide">
          ...
          <p className="ds-text--lead">At this time, the private beta is open only to 2017 CMS-approved Qualified Registries ("registries") and Qualified Clinical Data Registries ("QCDRs").  Additional partners such as EHR vendors may soon qualify.  To participate, request an API key by contacting the Quality Payment Program Service Center at <a href="mailto:qpp@cms.hhs.gov?subject=Request%20API%20Key%20for%20Submissions%20API%20Beta">QPP@cms.hhs.gov</a>.</p>
