          ...
          <div className='modal-content'>
            ...
            <div className='modal-body'>
              <div className='clearfix'>
                <div className='pull-left'><img src='https://qpp.cms.gov/images/cmsLogo.jpg' width='245' height='86' title='CMS Centers for Medicare &amp; Medicaid Services' alt='CMS Centers for Medicare &amp; Medicaid Services' /></div>
                <div className='pull-left'>
                  <h5>Centers for Medicare &amp; Medicaid Services</h5>
                  <p className='small'><a href='https://www.cms.gov' target='_blank' rel='noopener noreferrer' aria-label='www.cms.gov This opens in a new window'>www.cms.gov&nbsp;</a>|&nbsp;<a href='https://www.medicaid.gov' target='_blank' rel='noopener noreferrer' aria-label='www.medicaid.gov This opens in a new window'>www.medicaid.gov&nbsp;</a>|&nbsp;<a href='https://www.medicare.gov' target='_blank' rel='noopener noreferrer' aria-label='www.medicare.gov This opens in a new window'>www.medicare.gov</a></p>
                </div>
              </div>
