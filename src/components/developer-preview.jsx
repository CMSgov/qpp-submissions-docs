...
export default class DeveloperPreview extends React.PureComponent {
  render() {
    return (
        ...
        <h1 className="ds-h1">QPP Submissions API<br/>Developer Preview</h1>  
