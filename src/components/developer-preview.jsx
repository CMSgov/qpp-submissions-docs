  ...
  render() {
    return (
        ...
        <h1 className="ds-h1">Developer Preview</h1>
          ...
          <p class="ds-text">Email <a href="mailto:QPP@cms.hhs.gov?subject=Request%20API%20Key%20for%20Submissions%20API%20Developer%20Preview">QPP@cms.hhs.gov</a> to request your API Token for the Developer Preview.</p>
          <p class="ds-text">CMS will verify that the requestor’s organization is a 2017 Qualified Registry or QCDR (additional partners such as EHR vendors may soon qualify) and contact you with your API Token. </p>
          <p class="ds-text">Please note: API Tokens expire at the end of the Developer Preview period, at which time new API Tokens will become available through an automated, self-service process.</p>
