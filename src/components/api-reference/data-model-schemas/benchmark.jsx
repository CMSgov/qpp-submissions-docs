...
export default class Benchmark extends PureComponent {
  ...
  status: string
      ...
      <p className="ds-text--lead">*It is possible for there to be both a current and historical benchmark for any given measureId, submissionMethod, and performanceYear combination. In such a case, the historical benchmark will always be the one to be passed to the scoring engine and used for scoring.</p>
      ...
      <h3 className="ds-h2">Benchmark Calculations</h3>
