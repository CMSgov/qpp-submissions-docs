...
const FIELDS = [
  ...
  {name: 'isToppedOut', value: 'boolean', description: 'A boolean value that represents whether the latter deciles of a benchmark top out and repeat a value of 100', notes: 'Read-only'},
