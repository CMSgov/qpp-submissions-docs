...
const FIELDS = [
  ...
  {name: 'measureSet', value: 'string', description: 'The speciality set which the measurement set is attesting. Acceptable values are <b>"generalSurgery"</b> or <b>"other"</b>', notes: 'writable, optional'},
