...
const SINGLE_PERFORMANCE_RATE_FIELDS = [
  ...
  {name: 'reportingRate', value: 'float', description: 'The reporting rate, ranging from zero to one-hundred and representing a percentage, is equal to ((performanceMet + performanceExclusion + and performanceNotMet) / populationTotal) * 100: .', notes: ''},
  {name: 'performanceRate', value: 'float', description: 'The performance rate, ranging from zero to one-hundred and representing a percentage, is equal to (performanceMet / (performanceMet + performanceNotMet)) * 100.',  notes: ''}
];
...
const STRATA_FIELDS = [
  ...
  {name: 'reportingRate', value: 'float', description: 'The reporting rate, ranging from zero to one-hundred and representing a percentage, is equal to ((performanceMet + performanceExclusion + and performanceNotMet) / populationTotal) * 100: .', notes: ''},
  {name: 'performanceRate', value: 'float', description: 'The performance rate, ranging from zero to one-hundred and representing a percentage, is calculated based on the overallAlgorithm of the measure. Currently, a measure\'s overallAlgorithm can be a <b>simpleAverage</b>, <b>weightedAverage</b>, or <b>sumNumerators</b>.',  notes: ''}
];
