    ...
    return (
      <div>
        ...
        <ul>
          ...
          <li>If you exceed the rate limit, you will receive a 403 Access Denied response, and your IP address will be blocked for 10 minutes. However, this 10-minute block is applied after you've terminated your excessive activity. So if you exceed the rate limit, you should cease your excessive activity for at least 10 minutes - otherwise, you will continue to receive 403s from the API.</li>
          <li>If your requests start to time-out, implement exponential backoff so that you do not continue to encounter timeouts (resource: https://cloud.google.com/storage/docs/exponential-backoff).</li>
