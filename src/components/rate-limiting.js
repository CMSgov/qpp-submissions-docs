    ...
    return (
      <div>
        ...
        <ul>
          ...
          <li>If your requests start to time-out, implement exponential backoff so that you do not continue to encounter timeouts (resource: <a href='https://cloud.google.com/storage/docs/exponential-backoff' target='_blank' rel='noopener noreferrer'> https://cloud.google.com/storage/docs/exponential-backoff)</a>.</li>
