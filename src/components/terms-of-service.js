  ...
  render() {
    return (
      <div>
        ...
        <p className='ds-text'>
          Return to the <a href='https://qpp.cms.gov/resources/developers' target='_blank' rel='noopener noreferrer'>QPP Developer Tools</a>.
        </p>
      </div>
    );
  }
